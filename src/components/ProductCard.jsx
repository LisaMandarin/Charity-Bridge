                    ...
                    <Card 
                        ...
                        cover={
                            <div className="w-full aspect-square">
                                <Image.PreviewGroup items={ item.photoURL.map(photo => ({ src: photo}))}>
                                    { productInfo.loading ? <Skeleton.Image active={true} style={{width: "100%", height: "100%"}}/> 
                                    : <Image alt={`${item.product}'s photo`} 
                                        src={item.photoURL[0]} 
                                        width="100%"
                                        height="100%"
