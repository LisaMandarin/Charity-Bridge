  ...
  return (
    <>
      ...
      <div className="w-full p-8 md:pt-8 bg-white">
        <div ref={avatarRef}>
          {div === "avatar" && <DashboardAvatar user={user} />}
        </div>
        <div ref={nameRef}>
          {div === "name" && <DashboardName user={user} />}
        </div>
        <div ref={passwordRef}>
          {div === "password" && <DashboardPassword user={user} />}
        </div>
        <div ref={profileRef}>
          {div === "profile" && (
            <DashboardProfile user={user} setDiv={setDiv} />
          )}
        </div>
        <div ref={postRef}>
          {div === "post" && <DashboardPost user={user} />}
        </div>
      </div>
    </>
  );
