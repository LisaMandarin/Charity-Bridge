...
export function MessageBoard() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-6rem-3.5rem)] md:w-[600px] shadow-md">
            ...
            <div>
                ...
                >
                    ...
                    <Form.Item className="mb-0">
                        <Button htmlType="submit" className="h-10 border-0" icon={<Icon icon="iconoir:send-solid" width={30} />}></Button>
                    </Form.Item>
                </Form>
            </div>
        </div>
